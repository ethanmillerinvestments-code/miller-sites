...
export default function CheckoutIntakePage({
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (body.mode === "manual_review" && body.mailto) {
                ...
                <PointerCard className="lux-panel rounded-[2rem] p-6 sm:p-8">
                  <div className="mb-6">
                    ...
                    <p className="muted-copy mt-3 text-sm leading-7">
                      ...
                      scope confirmation, timeline, and first implementation
                      pass will be.
                    </p>
                  </div>
                  ...
                  <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    {fallbackMailto ? (
                      <div className="rounded-2xl border border-[rgba(216,170,115,0.24)] bg-[rgba(216,170,115,0.08)] px-4 py-4 text-sm leading-7 text-stone-200">
                        <div className="flex items-start gap-3">
                          <span className="mt-1 flex h-10 w-10 items-center justify-center rounded-full border border-[rgba(216,170,115,0.24)] bg-[rgba(216,170,115,0.12)] text-[color:var(--accent-strong)]">
                          ...
                          <div>
                            <p className="font-semibold text-stone-50">
                              Manual review mode is active on this deployment.
                            </p>
                            <p className="mt-2">
                              The company brief is ready, but direct checkout is
                              intentionally disabled until the compliant payment
                              path is configured and the written scope is confirmed.
                            </p>
                          </div>
                        </div>
                        <div className="mt-4 flex flex-col gap-3 sm:flex-row">
                          <a href={fallbackMailto} className="button-primary px-5 py-3 text-sm">
                            Open Email Draft
                          </a>
                          <a
                            href={siteConfig.calendlyUrl}
