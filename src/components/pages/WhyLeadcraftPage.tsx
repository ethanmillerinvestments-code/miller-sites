...
export default function WhyLeadcraftPage({
  ...
  return (
    <SiteShell>
      ...
      <SectionBridge variant="glow-pulse" tone="accent" className="my-12" />

      <section className="section-pad section-rule">
        <div className="section-shell">
          <div className="grid gap-5 lg:grid-cols-2">
            {workModes.map((mode, index) => (
              <ScrollReveal key={mode.title} direction={index === 0 ? "left" : "right"} delay={0.06 + index * 0.06}>
                <article
          ...
          <ScrollReveal direction="scale-blur" delay={0.08}>
